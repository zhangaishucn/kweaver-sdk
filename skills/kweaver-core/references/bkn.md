...
kweaver bkn object-type create <kn_id> --name <n> --dataview-id <dv> --primary-key <pk> --display-key <dk> [--property '<json>' ...]  # 无 --property 时从 dataview 拉全字段并生成 mapped_field；有 --property 时可省略 mapped_field（CLI 补全）
